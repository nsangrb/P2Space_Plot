...
namespace P2Space
{
    class Chart3D
    {
        ...
        public P2Space.Vertex3D this[int n]
        {
            get
            {
        ...
        public void AddAxesMeshes(ArrayList meshs)
        {
            ...
            xAxisCylinder.SetColor(Color.FromRgb(255, 0, 0));
        ...
        public void AddAxesMeshes2point(ArrayList meshs,Quaternion q)
        {
            ...
            xAxisCylinder.SetColor(Color.FromRgb(255,0,0)) ;
            TransformMatrix.Transform(xAxisCylinder, new Point3D(m_xAxisCenter + m_xAxisLength / 2, m_yAxisCenter, m_zAxisCenter), 0, 90);
            TransformMatrix.Transform(xAxisCylinder,q);
            meshs.Add(xAxisCylinder);

            Mesh3D xAxisCone = new Cone3D(2 * radius, 2 * radius, radius * 5, 6);
            xAxisCone.SetColor(Color.FromRgb(255, 0, 0));
            TransformMatrix.Transform(xAxisCone, new Point3D(m_xAxisCenter + m_xAxisLength, m_yAxisCenter, m_zAxisCenter), 0, 90);
            TransformMatrix.Transform(xAxisCone, q);
            meshs.Add(xAxisCone);
       
            Mesh3D yAxisCylinder = new Cylinder3D(radius, radius, m_yAxisLength, 6);
            yAxisCylinder.SetColor(Color.FromRgb(0, 255, 0));
            TransformMatrix.Transform(yAxisCylinder, new Point3D(m_xAxisCenter, m_yAxisCenter + m_yAxisLength / 2, m_zAxisCenter), 90, 90);
            TransformMatrix.Transform(yAxisCylinder, q);
            meshs.Add(yAxisCylinder);

            Mesh3D yAxisCone = new Cone3D(2 * radius, 2 * radius, radius * 5, 6);
            yAxisCone.SetColor(Color.FromRgb(0, 255, 0));
            TransformMatrix.Transform(yAxisCone, new Point3D(m_xAxisCenter, m_yAxisCenter + m_yAxisLength, m_zAxisCenter), 90, 90);
            TransformMatrix.Transform(yAxisCone, q);
            meshs.Add(yAxisCone);
        
            Mesh3D zAxisCylinder = new Cylinder3D(radius, radius, m_zAxisLength, 6);
            zAxisCylinder.SetColor(Color.FromRgb(0, 0, 255));
            TransformMatrix.Transform(zAxisCylinder, new Point3D(m_xAxisCenter, m_yAxisCenter, m_zAxisCenter + m_zAxisLength / 2), 0, 0);
            TransformMatrix.Transform(zAxisCylinder, q);
            meshs.Add(zAxisCylinder);
            
            Mesh3D zAxisCone = new Cone3D(2 * radius, 2 * radius, radius * 5, 6);
            zAxisCone.SetColor(Color.FromRgb(0, 0, 255));
            TransformMatrix.Transform(zAxisCone, new Point3D(m_xAxisCenter, m_yAxisCenter, m_zAxisCenter + m_zAxisLength), 0, 0);
            TransformMatrix.Transform(zAxisCone, q);
            meshs.Add(zAxisCone);
           
        }

        public void AddAxesMeshes2point(ArrayList meshs,double argX,double argY)
        {
            if (!m_bUseAxes) return;
            float radius = 0.5f;
            Mesh3D xAxisCylinder = new Cylinder3D(radius, radius, m_xAxisLength, 6);
            xAxisCylinder.SetColor(Color.FromRgb(255, 0, 0));
            TransformMatrix.Transform(xAxisCylinder, new Point3D(m_xAxisCenter + m_xAxisLength / 2, m_yAxisCenter, m_zAxisCenter), 0, 90);
            TransformMatrix.Transform(xAxisCylinder, new Point3D(m_xAxisCenter , m_yAxisCenter, m_zAxisCenter), argX, argY,true);
            meshs.Add(xAxisCylinder);
            Mesh3D xAxisCone = new Cone3D(2 * radius, 2 * radius, radius * 5, 6);
            xAxisCone.SetColor(Color.FromRgb(255, 0, 0));
            TransformMatrix.Transform(xAxisCone, new Point3D(m_xAxisCenter + m_xAxisLength, m_yAxisCenter, m_zAxisCenter), 0, 90);
            TransformMatrix.Transform(xAxisCone, new Point3D(m_xAxisCenter, m_yAxisCenter, m_zAxisCenter), argX, argY, true);
            meshs.Add(xAxisCone);
            Mesh3D yAxisCylinder = new Cylinder3D(radius, radius, m_yAxisLength, 6);
            yAxisCylinder.SetColor(Color.FromRgb(0,255, 0));
            TransformMatrix.Transform(yAxisCylinder, new Point3D(m_xAxisCenter, m_yAxisCenter + m_yAxisLength / 2, m_zAxisCenter), 90, 90);
            TransformMatrix.Transform(yAxisCylinder, new Point3D(m_xAxisCenter, m_yAxisCenter, m_zAxisCenter), argX, argY, true);
            meshs.Add(yAxisCylinder);
            Mesh3D yAxisCone = new Cone3D(2 * radius, 2 * radius, radius * 5, 6);
            yAxisCone.SetColor(Color.FromRgb(0, 255, 0));
            TransformMatrix.Transform(yAxisCone, new Point3D(m_xAxisCenter, m_yAxisCenter + m_yAxisLength, m_zAxisCenter), 90, 90);
            TransformMatrix.Transform(yAxisCone, new Point3D(m_xAxisCenter, m_yAxisCenter, m_zAxisCenter), argX, argY, true);
            meshs.Add(yAxisCone);
            Mesh3D zAxisCylinder = new Cylinder3D(radius, radius, m_zAxisLength, 6);
            zAxisCylinder.SetColor(Color.FromRgb(0, 0, 255));
            TransformMatrix.Transform(zAxisCylinder, new Point3D(m_xAxisCenter, m_yAxisCenter, m_zAxisCenter + m_zAxisLength / 2), 0, 0);
            TransformMatrix.Transform(zAxisCylinder, new Point3D(m_xAxisCenter, m_yAxisCenter, m_zAxisCenter), argX, argY, true);
            meshs.Add(zAxisCylinder);
            Mesh3D zAxisCone = new Cone3D(2 * radius, 2 * radius, radius * 5, 6);
            zAxisCone.SetColor(Color.FromRgb(0, 0, 255));
            TransformMatrix.Transform(zAxisCone, new Point3D(m_xAxisCenter, m_yAxisCenter, m_zAxisCenter + m_zAxisLength), 0, 0);
            TransformMatrix.Transform(zAxisCone, new Point3D(m_xAxisCenter, m_yAxisCenter, m_zAxisCenter), argX, argY, true);
            meshs.Add(zAxisCone);
        }
        // select 
        ...
        public enum SHAPE { BAR, ELLIPSE, CYLINDER, CONE, PYRAMID, TRIP_AXIS };    // shape of the 3d dot in the plot
