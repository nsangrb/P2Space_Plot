...
namespace WPFChart3D
{
    ...
    public partial class Window1 : Window
    {
        ...
        public void Init_plot(Axis_L a, float x, float y, float z, double argX, double argY)
        {
            // 1. set the scatter plot size
            Random randomObject = new Random();
        ...
        public void Move_plot(Axis_L a, float x, float y, float z, double argX, double argY)
        {
            // 1. set the scatter plot size
            Random randomObject = new Random();
            m_3dChart = new Chart3D();
        ...
        public void Move_plot(Axis_L a, Quaternion q)
        {
            // 1. set the scatter plot size
            Random randomObject = new Random();
            m_3dChart = new Chart3D();
